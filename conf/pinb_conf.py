...
comparision = {
    'official_name': Comparator('NAZWA', 'official_name', single_match=True, print=lambda x: getnames(x).get('official_name') or getnames(x)['name'], strip=lambda x: x.lower().strip()),
